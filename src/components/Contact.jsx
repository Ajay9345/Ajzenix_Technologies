import { Mail, MapPin, Send, MessageCircle, Calendar } from 'lucide-react';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const formspreeEndpoint = "https://formspree.io/f/mblzoqpd"; // replace YOUR_FORM_ID
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Ready to transform your business with modern web solutions? Contact us today for a free consultation and custom quote.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">ajzenixtechnologies@gmail.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">30-minute strategy session</p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    >
                      ...
                      <option value="automation">Automation & Smart Tools</option>
